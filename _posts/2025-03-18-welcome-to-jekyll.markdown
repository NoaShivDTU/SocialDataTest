...
<figure>
  <img src="/NoaShivDTU/SocialData_assignment2/plots/polar_subplots.png" width="100%" height="300" alt="Polar Subplots" style="border:none;">
...
<figure >
  <iframe 
      src="/NoaShivDTU/SocialData_Assignment2/plots/crime_animation_map.html" 
      width="100%" 
      height="900"
...
<figure >
  <iframe 
      src="/NoaShivDTU/SocialData_Assignment2/plots/bokeh_overlay_plot.html" 
      width="100%" 
      height="900"
      style="max-width: 1200px; margin: auto; display: block; border: none;">
  </iframe>
